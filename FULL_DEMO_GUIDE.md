...
- Save results to `trajectory_comparisons/highway/`
...
**Output directories:**
- Global: `demonstration_RL_expert/highway_annotated/`
- Sliding: `demonstration_RL_expert/highway_sliding_annotated/`
- Fast: `demonstration_RL_expert/highway_fast_annotated/`
...
**Graphs will be saved to:** `trajectory_comparisons/highway/`
...
```
trajectory_comparisons/highway/
```
...
## Example: Full Demo for Highway Scenario
...
### Data Directories:
- `demonstration_RL_expert/highway_annotated/` - Global method results
- `demonstration_RL_expert/highway_sliding_annotated/` - Sliding method results
- `demonstration_RL_expert/highway_fast_annotated/` - Fast method results

### Comparison Results:
- `trajectory_comparisons/highway/` - Directory with all comparison graphs
- `comparison_results_highway.pkl` - Numerical results (if --output_file specified)
